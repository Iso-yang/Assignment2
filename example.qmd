...
-   Inside the project, I created a file `example.qmd`.

# Step 2: Initialise the Git repository and push to GitHub

Initialize a Git repository in the current folder. Create a .git/ directory, and Git starts tracking files and version history that can be knitted into a HTML file.
